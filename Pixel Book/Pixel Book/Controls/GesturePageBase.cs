...
namespace Pixel_Book.Controls
{
    ...
    public class GesturePageBase : Windows.UI.Xaml.Controls.Page
    {
        ...
        public GesturePageBase(String uniqueId, String title, String description, String similarTo, String imagePath)
        {
            ...
            var appBar = (Windows.UI.Xaml.Controls.AppBar)Pixel_Book.SemanticZoomPage.Current.FindName("globalAppBar");
    ...
    {
        public GesturePageInfo(String uniqueId, String title, String description, String similarTo, String imagePath, Pixel_Book.Controls.GesturePageBase playArea)
        {
        ...
        private Pixel_Book.Controls.GesturePageBase _playArea;
        public Pixel_Book.Controls.GesturePageBase PlayArea
        {
